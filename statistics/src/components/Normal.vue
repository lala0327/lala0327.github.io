<template>
  ...
  <div class="flex justify-center items-center flex-col">
    <div class="w-[95%] h-[100%] max-w-[650px]">
      <div class="my-[5px] flex justify-center">
        <span>&#956;：</span
        ><input type="number" v-model="mu" class="w-full" />
        <span class="ml-[10px]">&#963;：</span
        ><input type="number" v-model="sigma" class="w-full" @change="check" />
      </div>
